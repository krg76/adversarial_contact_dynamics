...
model_path = "comfree_warp/benchmark/test_data/primitives.xml"
...
if engine != 0:
    if engine == 1:
        ...
        comfree_stiffness_vec = [0.1,0.001,0.00001] # Default stiffness value
        comfree_damping_vec = [0.001,0.001,0.0001]  # Default damping value
